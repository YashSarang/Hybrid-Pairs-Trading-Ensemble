...
We tested the same pairs trading system on stock markets in India, the United States, Brazil, and the United Kingdom. India's Nifty 50 index produced dramatically better returns than India's Nifty 100 index (+0.700 Sharpe uplift, best run +0.840), while the US lost money—proving that **universe quality and market selection matter far more than algorithm design**. The conventional wisdom that pairs trading is dead is wrong: it's dead in developed markets but alive in emerging markets, if you pick the right universe.
